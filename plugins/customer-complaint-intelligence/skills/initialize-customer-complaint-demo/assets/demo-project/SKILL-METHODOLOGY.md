...
- A batch can be structurally complete while its derived fields have drifted onto neighboring source records. Row counts, schemas, and allowed values can all pass even though the handoff is semantically wrong.
